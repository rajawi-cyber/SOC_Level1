...
Welcome! This repository documents all my notes and practical exercises while studying the **SOC Level 1 Learning Path** on TryHackMe.

The goal of this repository is to build a **portfolio** demonstrating my skills as a Junior SOC Analyst, including notes, Markdown files, and screenshots as evidence.
...
## 🎯 Goals
- Build practical experience as a Junior SOC Analyst  
- Learn to handle alerts, triage, investigations, and analysis  
- Document all exercises in an organized and professional way for GitHub portfolio
